...
<body>
    ...
    <main>
        ...
        <section id="experiencia" class="layout2 --imagen-paredes-concreto">
            <div>
                <p class="texto-medio-grande"><span>Más de</span><span class="texto-medio">30 años</span><span>Construyendo sueños</span></p>
            </div>
            <div>
        ...
        <section id="clientes">
            ...
            <div  class="layout3 --l390vh">
                    <div class="cliente">
                        ...
                        <p>Jorge Eugenio Gigante</p>
                        <p>"Concretos Arciniega ha sido el elemento fundamental que me permitío hacer realidad todos mis proyectos"</p>
                    </div>
                    <div class="cliente">
                        <div class="contenedor-cliente">
                            <img src="./img/cliente2.png" alt="Cliente 1">
                        </div>
                        <p>María de Jesús Casillas</p>
                        <p>"Los mejores precios y envíos en el momento en el que lo necesito"<br> </p>
                    </div>
                    <div class="cliente">
                        <div class="contenedor-cliente">
                            <img src="./img/cliente3.png" alt="Cliente 1">
                            <p>"DJ tilin insano 4000"</p>
...
<!-- <script src="./scipts/header.js"></script> -->
</html>